...
#taken from https://github.com/eladhoffer/utils.pytorch/blob/master/cross_entropy.py
...
class CrossEntropyLoss(nn.CrossEntropyLoss):
    ...
    def __init__(self, weight=None, ignore_index=-100, reduction='mean', smooth_eps=0.1, smooth_dist=None):
